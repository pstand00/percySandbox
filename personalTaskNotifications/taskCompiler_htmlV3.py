...
try:
    ...
    for i in headerTaskDf1['status'].unique():
        ...
        # a potential way to create some sort of overlap [used for highlights!! or shadows!!]
        listItemStr = (
            """
            <p><div style="width:auto;height:60px;margin:0 auto;">  
            <div style="max-height:0;max-width:0;">
            <div style="color:#FFE459;width:300px;height:auto;margin-top:10px;margin-left:30px;display:inline-block;text-align:left;font-size:25px">""" + 
            i + 
            """</div>
            </div>""" + 
            """<div style="max-height:0;max-width:0;">
            <div style="color:#F8F3EC;width:300px;height:auto;margin-top:12px;margin-left:32px;display:inline-block;text:left;font-size:25px">""" + 
            i + 
            """</div>
            </div>""" +
            """<div style="max-height:0;max-width:0;">
            <div style="color:#FFE459;width:300px;height:auto;margin-top:11px;margin-left:31px;display:inline-block;text-align:left;font-size:25px">""" + 
            i + 
            """</div>
            </div>""" + 
            """<div style="max-height:0;max-width:0;">
            <div style="color:#FF5E54;width:300px;height:auto;margin-top:9px;margin-left:29px;display:inline-block;text:left;font-size:25px">""" + 
            i + 
            """</div>
            </div>""" + 
    ...
    bodyStr = bodyStr + "</div></div></body></html>"
